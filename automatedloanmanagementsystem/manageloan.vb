Public Class manageloan
    ...
    Private Sub manageloan_FormClosed(sender As Object, e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        homeform.f_mngloan = False
        close_all()
    End Sub

    Private Sub manageloan_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        homeform.f_mngloan = True
        effect_Permission()
        add_loan_type()
        add_loan_name()
        add_cus_id()
    ...
    Private Sub btn_add_sec_mng_Click(sender As System.Object, e As System.EventArgs) Handles btn_add_sec.Click
        If s_err = False Then
    ...
    Private Sub l_name_SelectedIndexChanged(sender As System.Object, e As System.EventArgs) Handles l_name.SelectedIndexChanged
        'update id
        loan_id.Text = lid
    End Sub

    Private Sub l_name_TextChanged(sender As System.Object, e As System.EventArgs) Handles l_name.TextChanged
        'update id
        loan_id.Text = lid
    End Sub
    ...
    Private Sub add_loan_name()
        l_name.Items.Clear()
        l_name.Items.Add("Loan001")
        l_name.Items.Add("Loan002")
        l_name.Items.Add("Loan003")
    End Sub
